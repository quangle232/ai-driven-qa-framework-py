...
BLOCKED_PREFIXES = (
    ...
    "conftest.py",
    "pyproject.toml",
    "src/aiqa_framework/core/auth.py",
    "src/aiqa_framework/jira/",
    "src/aiqa_framework/config/",
    "ci/",
    "src/aiqa_framework/grpc/proto/",
    "src/aiqa_framework/api/contracts/",
    ".github/",
    ".gitlab-ci.yml",
    ".git/",
)

_SECRET_RX = re.compile(r"(?:password|api[_-]?key|token|secret)\s*[:=]\s*[\"'][^\"']{6,}[\"']", re.IGNORECASE)
