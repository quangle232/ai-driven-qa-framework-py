...
from aiqa_framework.api.services.auth_service import AuthService
from aiqa_framework.api.services.user_service import UserService
...
def test_invalid_email_400(api_client) -> None:
    res = UserService(api_client).create_expecting_bad_request({"username": "x", "email": "not-an-email"})
